...
> **Note to Kate** We never run an install.packages in a code chunk otherwise we will re-install needlessly every time we render our document. Do it in the console instead.
