...
- [treated.counts \<- rowMeans( counts\[,metadata\$dex
  ==“treated”\])](#treatedcounts---rowmeans-countsmetadatadex-treated)
...
compare the control vs the treated to see which gene’s expression levels
...
> Q. Do the same for “treated” samples - find the mean count per value
> per gene.
...
Let’s put these two mean values int a new data.frame `meancounts` for
...
![](Class013_files/figure-commonmark/unnamed-chunk-14-1.png)
...
![](Class013_files/figure-commonmark/unnamed-chunk-15-1.png)
...
> Q. Add a new column `log2fc` for log2 fold change of the
...
A useful summary figure pf our results is often called a volvano plot.
...
![](Class013_files/figure-commonmark/unnamed-chunk-26-1.png)

This is not useful because the y-axis (P-value) is not really helpful -
...
![](Class013_files/figure-commonmark/unnamed-chunk-27-1.png)
...
![](Class013_files/figure-commonmark/unnamed-chunk-30-1.png)
...
![](Class013_files/figure-commonmark/unnamed-chunk-31-1.png)
...
![](Class013_files/figure-commonmark/unnamed-chunk-33-1.png)
...
We will use two biocundoctor packages for this “mapping”
**AnnotationDbi** and **org.Hs.eg.db**.

We wull first need to install these from biocunductor with
...
```
    ...
    Info: Working in directory /Users/kateruiz/Desktop/BIMM 143/bimm143_github/Class013

    Info: Writing image file hsa05310.pathview.png

![](hsa05310.pathview.png)

> Q. Generate and insert a pathway for “Graft-versus-host disease” and
> “Type I diabetes”?
